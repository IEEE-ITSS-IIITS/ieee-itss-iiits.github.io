...
import { ADVISORS, STUDENT_TEAM, DOMAINS } from '../../data';
        ...
        <div className="pt-32 pb-32 max-w-7xl mx-auto px-6">
            ...
            <div className="mb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {DOMAINS.map((d) => (
                        <div key={d.id} className="p-8 border border-foreground/5 rounded-3xl hover:border-accent/20 transition-all bg-white/70">
            ...
            <section className="mb-32">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative bg-white/85 border border-foreground/5 p-10 rounded-[2.5rem] w-full max-w-[320px] aspect-square flex flex-col items-center justify-center hover:border-accent/20 transition-colors duration-200"
                    >
                        <div className="absolute top-8 left-8 w-8 h-8 border-t border-l border-accent/20 rounded-tl-xl" />
                        <img
                    ...
                    <motion.div
                        ...
                        className="relative bg-white/85 border border-foreground/5 p-10 rounded-[2.5rem] w-full max-w-[320px] aspect-square flex flex-col items-center justify-center hover:border-accent/20 transition-colors duration-200"
                    >
                        <div className="absolute bottom-8 right-8 w-8 h-8 border-b border-r border-accent/20 rounded-br-xl" />
