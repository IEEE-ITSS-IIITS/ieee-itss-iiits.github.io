        ...
        <div className="pt-32 pb-32 max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-32">
                ...
                <div className="md:col-span-7">
                    <img src="/assets/slide_1_image_89.png" alt="Lab" className="w-full rounded-3xl shadow-2xl" referrerPolicy="no-referrer" loading="lazy" />
                </div>
            </div>
            ...
            <div className="mb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {DOMAINS.map((d) => (
                        <div key={d.id} className="p-8 border border-foreground/5 rounded-3xl hover:border-accent/20 transition-all bg-white/30 backdrop-blur-sm">
